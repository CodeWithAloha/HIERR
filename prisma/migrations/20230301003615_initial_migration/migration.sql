...
VALUES
    ...
    (@answerId58, @questionId13, '$10,000 but less than $15,000', 2, 'option'),
    (@answerId59, @questionId13, '$15,000 but less than $25,000', 3, 'option'),
    (@answerId60, @questionId13, '$25,000 but less than $35,000', 4, 'option'),
    (@answerId61, @questionId13, '$35,000 but less than $50,000', 5, 'option'),
    (@answerId62, @questionId13, '$50,000 but less than $75,000', 6, 'option'),
    (@answerId63, @questionId13, '$75,000 but less than $100,000', 7, 'option'),
    (@answerId64, @questionId13, '$100,000 but less than 150,000', 8, 'option'),
    (@answerId65, @questionId13, '$150,000 but less than $200,000', 9, 'option'),
    (@answerId66, @questionId13, '$200,000 or more', 10, 'option'),
    (@answerId67, @questionId13, 'Don’t know/Prefer not to answer', 11, 'option')
