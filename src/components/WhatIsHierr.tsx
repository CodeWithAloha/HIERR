...
const Goals = () => {
  return (
    <ol className="mb-2 ml-4 list-decimal text-primary-content 2xl:text-lg">
...
const ByTheEndOfThisProject = () => {
  return (
    <ul className="mb-2 ml-4 list-disc text-primary-content 2xl:text-lg">
      <li className="md:mb-2">
...
const WhatIsHierr = () => {
  return (
    <>
      <p className="mb-2 mt-4 text-center text-primary-content 2xl:text-lg">
        HIERR stands for{" "}
      </p>
      <h3 className="text-md pb-2 pl-2 text-center font-semibold text-primary-content 2xl:text-xl">
        Hawai&#699;i Economic Recovery and Resilience
      </h3>

      <div className="h-[1px] w-full bg-blue-darker/40 md:my-4"></div>
      <h2 className="text-md py-2 font-semibold text-primary-content 2xl:text-xl">
        Project Overview
      </h2>
      <p className="mb-2 text-primary-content 2xl:text-lg">
      ...
      <h2 className="text-md pb-2 font-semibold text-primary-content 2xl:text-xl">
        Goals:
      </h2>
      <Goals />
      <h2 className="text-md pb-2 font-semibold text-primary-content 2xl:text-xl">
      ...
      <div className="h-[1px] w-full bg-blue-darker/40 md:my-4"></div>
      <p className="pt-2 text-center text-primary-content 2xl:text-lg">
        Visit our{" "}
        <a
